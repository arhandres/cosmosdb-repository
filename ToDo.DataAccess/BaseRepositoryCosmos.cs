...
namespace ToDo.DataAccess
{
    public abstract class BaseRepositoryCosmos<T> : BaseRepository<T> where T : class
    {
        ...
        public BaseRepositoryCosmos(string endpointUri = null, string primaryKey = null, string databaseName = null)
        {
        ...
        protected override bool Upsert(T entity)
        {
            var uri = UriFactory.CreateDocumentCollectionUri(_databaseName, _documentCollection.Id);
        ...
        protected override bool Delete(T entity)
        {
